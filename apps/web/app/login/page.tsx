    ...
    <div className="flex min-h-screen items-center justify-center px-4" style={{ backgroundColor: "var(--color-bg)" }}>
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--color-text-secondary)" }}>다함께교실에 오신 것을 환영합니다</p>
        </div>

        {/* 소셜 로그인 */}
        <div className="mb-6 space-y-3">
          <button onClick={() => handleSocialLogin("google")} className="input-field flex items-center justify-center gap-2 font-semibold">
            <span>🇬</span> Google로 로그인
          </button>
          <button onClick={() => handleSocialLogin("apple")} className="input-field flex items-center justify-center gap-2 font-semibold">
            <span></span> Apple로 로그인
          </button>
          <button onClick={() => handleSocialLogin("facebook")} className="input-field flex items-center justify-center gap-2 font-semibold">
